 ...
 * @file com.iterlife.xspring.servlet.XServletResponse.java
 * @version 1.0.0
 ...
 * @desc
 * @author Lu Jie
 * @date 2019 2019年2月6日 下午12:09:03
 * @tags
 */
public interface XServletResponse {
	 ...
	 * been specified, and a character encoding has been explicitly or
	 * implicitly specified as described in {@link #getCharacterEncoding} or
	 * {@link #getWriter} has been called, the charset parameter is included in
	 * the string returned. If no character encoding has been specified, the
