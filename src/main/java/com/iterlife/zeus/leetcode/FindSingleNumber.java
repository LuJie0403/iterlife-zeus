 ...
 * @file com.iterlife.zeus.algorithm.FindSingleNumber.java
 * @version 1.0.0
...
/**
 *
 * @desc https://leetcode-cn.com/problems/single-number-iii/
...
public class FindSingleNumber {
	...
	public static void main(String[] args) {
		...
		System.out.println(new FindSingleNumber().singleNumber1(a));;
