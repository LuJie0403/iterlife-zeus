 ...
 * @file com.iterlife.xspring.servlet.XServlet.java
 * @version 1.0.0
 ...
 * @desc
 * @author Lu Jie
 * @date 2019 2019年2月6日 下午12:52:36
 * @tags
 */
public interface XServlet {
	/**
	...
	public void init(XServletConfig config) throws XServletException;
	...
	public XServletConfig getServletConfig();
	...
	public void service(XServletRequest req, XServletResponse res)
